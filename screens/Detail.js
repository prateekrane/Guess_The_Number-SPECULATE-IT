        ...
        <View style={{ flex: 1 }}>
          ...
          >
            ...
            <ScrollView style={{ flex: 1 }}>
              ...
              <Text style={styles.infotxt}>
                {"2.Dont try to enter negative number or more than 99. \n"}
              </Text>
              <Text style={styles.infotxt}>
                {
                  "3.After entering the number hint your mobile wheather the your number is grater or smaller than the generated number. \n"
                }
              </Text>
              <Text style={styles.infotxt}>
                {
                  "4.Dont try to miss lead your mobile, Although my code will catch you ;). \n "
                }{" "}
              </Text>
